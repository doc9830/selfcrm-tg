...
export type IconName =
  ...
  | 'arrow-down'
  | 'arrow-up'
  // Печать и «поделиться» — действия на странице чека.
  | 'print'
  | 'share'
  // Звено цепи — «Скопировать ссылку»: запасной путь, когда выбор чата не открылся.
  | 'link'
...
const ICONS: Record<IconName, ReactNode> = {
  ...
  // Принтер — печать чека (на iPhone печать сохраняет PDF в «Файлы»).
  print: (
    <>
  ...
  // Три узла и связи — «Поделиться»: системное меню или выбор чата Telegram.
  share: (
    <>
  ...
  // Звено цепи — «Скопировать ссылку»: ссылку вставляют в чат руками, когда выбор чата
  // не открылся.
  link: (
    <>
